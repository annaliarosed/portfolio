  ...
  return (
    <main className={styles.main}>
      <article className={styles.container}>
        <header className={styles.hero} aria-labelledby="project-title">
          ...
          <div className={styles.metaRow}>
            ...
            <div className={styles.linkGroup}>
              ...
              <span className={styles.topLinkDisabled} aria-disabled="true">
                Demo unavailable
              </span>
            </div>
          </div>
        ...
        <header className={`${styles.hero} ${styles.caseStudySpacer}`} aria-labelledby="dundee-title">
          <p className={styles.kicker}>Case Study</p>
